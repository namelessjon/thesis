...
A typical human myocyte is from 50 to \um{150}\ long, and has a radius
between 10 and \um{20}.
...
myofibril-like units, long branching fibres about \um{1}\ in diameter.
These fibres are divided up into sarcomeres, approximately \um{2}\ long in the
...
Restitution is often rate-dependent too; It is not just the immediately
...
The thin filaments are about \um{1.050}\ long and a mere \unit{6}{nm} in diameter.
Their ends are embedded in the Z lines, which delineate the sarcomeres.
The thick filament is made of myosin, and is about \um{1.6}\ long, and
...
\subsection{Activation Sequence of the Heart}
