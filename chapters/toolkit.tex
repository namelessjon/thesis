...
\caption[Anion Sensitive AP Profile]{\label{anion:ap} AP profile for the CRN model without
(black) and with (red) the $NO_{3^{-}}$ carrying current included.  The AP
morphology is largely unchanged although there is a depressed plateau region and
a slightly elevated resting potential.}
\end{figure}
