...
APD\emph{r}{\scriptsize,90}\ and the APD\emph{r}{\scriptsize,50} were calculated
as described previously.  There were 9 S1 stimuli at a frequency of
...
strand simulations there was 1 S1 pulse and one S2 pulse.
...
The APDr curves, shown in Figure~\ref{fig:apdr}, are flatter over much
...
In AF tissue, the ERPr was flattened for all tissue types compared with
the control cells, as shown in Figure~\ref{fig:erpr}.  This also allowed
successful excitation at lower BCLs for AF tissue than was possible in
control tissue. Heterogeneity in ERPr was largely unaffected by AF.
...
excitable after pacing at 100~ms shorter BCL.}
\label{fig:erpr}
\end{figure}

Conduction velocity, shown in Figure~\ref{fig:cvr}, was slowed by AF,
reducing the solitary wave velocity from 0.27~mm~ms\supers{-1}\ in
control to 0.25~mm~ms\supers{-1} in AF1 and 0.26~mm~ms\supers{-1} in
AF2.  Maximal pacing rate increased from the control value of 198~bpm to
421~bpm in AF1 strands and 315~bpm in AF2 strands.

The VW was reduced by AF, but in all cell types the reduction was small.
The control value of 16.6~ms was reduced to 14.2~ms in AF1 and 14.7~ms
in AF2 for AM and PM cell types.  The reduction in VW for CT cells was
even smaller, from 15.1~ms in control to 14.5~ms and 14.4~ms in AF1 and
AF2, respectively.
...
electrically heterogeneous case, taking 1.31~s, compared with 3.20~s in
the homogeneous case.

Conversely, under AF conditions the re-entry persisted after it was
induced for the whole period of the simulation, a lifespan of over 5~s.
