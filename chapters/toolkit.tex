...
and it increases the difference in \apd\ between normal atrial
...
Control parameter traces are black, AF1 (Bosch) are red and AF2 (Workman) traces
blue.
...
Colour scheme as for panel \textbf{A}.
There is almost no difference in $\delta$\apd\ between control and AF1 CT cells,
but $\delta$\apd\ increased markedly when AF2 parameters are used.
}
\end{figure}
