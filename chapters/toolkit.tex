...
Refractory Period restitution, ERP\emph{r}.  In all the single cell cases, the
...
figure~\ref{anion:erpr}.  In both cases the ERP\emph{r}\ curves are relatively flat,
...
(red) cases.  The ERP\emph{r} curves are relatively flat for both cases.  The ERP is
always greater for the anion case.  In addition, the control case allows
successful excitation after pacing at \ms{25} shorter BCL.}
\end{figure}
