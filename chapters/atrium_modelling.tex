...
human atrium~\cite{Harrild2000,Zemlin2001,Vigmond2001,Seemann2006}\ which use
some variant of a biophysical model for the atria.
Others, such as the cellular automaton approach employed by Reumann et
al.~\cite{Reumann2007}\ are not discussed here.
...
The Zemlin~\cite{Zemlin2001}\ model was also based on the visible human dataset.
...
investigations~\cite{Zhang2005,Workman2001,Bosch2005}.
