...
\textbf{A} View up into the right atrium, showing the pectinate muscles
(orange), crista terminalis (yellow) and sino-atrial node (red).  The atrial
muscle is shown in blue.
\textbf{B} A view of the atrial geometry looking down onto the wall of the right
...
view (\textbf{A}) and a view up into the atria from the ventricles (\textbf{B}).
...
Figure~\ref{atrium:validation:main}\ and Figure~\ref{atrium:validation:valves}.
A map of activation times over the whole atria are shown in
Figure~\ref{atrium:validation:times}.
...
openings)]{
\label{atrium:validation:valves}
Simulated propagation of electrical excitation over the atrial model.
Excitation is initiated in the region corresponding to the sinus node.
Excitation spreads fastest along the fibres of the crista terminalis and the
pectinate muscles.
...
\label{atrium:validation:times}
Activation times of the atrial geometry from a frontal view (\textbf{A}) and a
view up into the atria from the ventricles (\textbf{B}).
...
\subsection{Comparisons with Real Studies}
...
muscle~\ref{hansson1998}, \unit{0.7}{m/s}---\unit{1.3}{m/s}\ for crista
terminalis~\ref{Boineau1988} in the human atrium.
...
human atrium~\ref{harild2000,zemlin2001,vigmond2001,seemann2006}.
They represent a range of electrophysiological detail, fibre structure and
computational complexity.
The model of Harild and Herenriqez~\ref{harild2000}\ has a detailed fibre
...
The Zemlin~\ref{zemlin2001}\ model was also based on the visible human dataset.
...
The Vigmond~\ref{vigmond2001}\ is an idealised model of an unusual construction.
...
The Seemann~\ref{seemann2006}\ is closely related to the model proposed in this
chapter--it would be accurate to say that this model is a simplification of the
model by Seemann et al.
The Seemann et al. model features an autoactive sino-atrial node complex.
...
Figure~\ref{atrium:iks:aps},C shows the current profiles of \ii{Ks} over the course of
...
\textbf{A} Unsuccessful attempt at initiating figure-of-eight re-entry just
before (I) and after (II) re-entry would occur.
\textbf{B} Successful initiation of figure-of-eight re-entry just before (I) and
just after (II) re-entry is initiated.
\textbf{C} Spatial vulnerability window for WT (black), HT10 (red) and HT25
(pink) tissue.
...
Snapshots of the membrane potential for WT (top panels) and HT10 (bottom
...
gain of function in the \ii{Ks}\ to SQT syndromes.
...
Limitations of the Courtemanche et al. model have been discussed
...
Recent clinical studies have identified several numerous genes responsible for a
propensity towards AF due to reductions in the ERP and \apd.
A recent modelling study of mutation in the KCNJ2 Kir2.1 gene, leading to gain
...
automaton based model of the human atria to study AF.
...
The model presented in this chapter represents the most biophysically detailed
and anatomically accurate model of AF in the human atria to date.
