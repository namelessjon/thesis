...
This is lower than the value used for the atrium model in healthy conditions.
This value allows scroll waves to be initiated easily.
It also emulates the conduction velocity reduction often seen in pathological
conduction cases.
