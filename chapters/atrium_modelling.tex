...
The numerical implementation was tested for stability by reducing the timestep to \ms{0.002}.
...
compared to the traces generated at the longer, \ms{0.02}, timestep.
...
The solid red line is a tracing from simulation at \ms{0.02}, the dashed from
\ms{0.002}.
...
\input{chapters/studies/afer}

\input{chapters/studies/anion}
